    ...
    return (
      <div className={styles.steps}>
        {steps.map((s, i) => (
          ...
          >
            <div
              className={`${styles.step} ${stepNum === s.n ? styles.active : ""} ${
                stepNum > s.n ? styles.done : ""
              }`}
            >
                ...
                <div>
                  <div className={styles.card} style={{ animation: "rise .35s ease both" }}>
                    ...
                    <div className={styles.previewBar}>
                      ...
                      >
                        <i
                          className={showBg ? "fa-solid fa-eye-slash" : "fa-solid fa-eye"}
                        ></i>
                    ...
                    <div className={styles.settingBlock}>
                      <div className={styles.swatchGrid}>
                        {BG_SWATCHES.map((sw) => (
                          <div
                            key={sw.c}
                            className={`${styles.swatch} ${sw.dark ? styles.onDark : ""} ${
                              activeSwatch === sw.c ? styles.active : ""
                            }`}
                            style={{
                              background: sw.c,
